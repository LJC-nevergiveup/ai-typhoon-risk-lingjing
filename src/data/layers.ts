...
export const LAYER_DEFS: LayerDef[] = [
  ...
  { id: 'satellite', label: '卫星云图', color: '#e8f1f8', hint: '葵花卫星真彩（演示瓦片）', demoOnly: true },
  ...
  { id: 'riskZones', label: '风险分区', color: '#f2a33c', hint: '沿海风险示意（仅 DEMO）', demoOnly: true },
  { id: 'landfalls', label: '登陆点', color: '#e64545', hint: '台风登陆点（REAL 数据）' },
  { id: 'shelters', label: '避险点', color: '#2ee6a8', hint: '应急避难场所（仅 DEMO）', demoOnly: true },
]
