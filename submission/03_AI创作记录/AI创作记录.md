...
- **人工核验**：作者信息已回填（李金澄，中国地震局兰州地震研究所，个人参赛）；正式访问 URL 已回填；历史会话截图待人工补录、素材许可终审；本文档所写科学数值均与 `docs/competition/data-provenance.md`、各 manifest / sources.json 核对一致，未改动任何数值。
